...
let mainHeader = document.getElementById('main_header').style.color = 'purple';

// b) робить шириниу елементу ul 400px

let ulWidth = document.getElementsByTagName('ul')[0].style.width = '400px'
...
for (const aCollectionElement of aCollection) {
    if(aCollectionElement.innerText === "link3")
        aCollectionElement.style.fontSize = '40px';
}

// h) отримує всі елементи 'a' та додає їм клас element_XXX. Де XXX - текстовий контент елементу a
let aCollection2 = document.getElementsByTagName('a');
for (const aCollection2Element of aCollection2) {
    aCollection2Element.classList.add("element");
    aCollection2Element.innerText = "XXX";
}
